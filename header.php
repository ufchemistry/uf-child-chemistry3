...
<?php
	##$menuFile = get_theme_root() . '/' . get_template() . '/library/php/menu.php';
	##print("<!-- *test menuFile={$menuFile} -->*");
	##include('library/php/menu.php'); //menu logic
	include(get_theme_root() . '/' . get_template() . '/library/php/menu.php'); //menu logic
?>